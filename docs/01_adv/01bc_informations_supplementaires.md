...
[](../media/acces_infos_libres.gif)

---
[⬇️Actions à suivre](01bc_informations_supplementaires.md#^bas.md)
...
> >
> [En savoir plus sur l'affichage des PL sur le terminal](../01_prepa/0_priorite.md)
...
---
[⬆️ Revenir en haut](01bc_informations_supplementaires.md#Présentation des infos libres haut.md)

##### Actions à suivre ^bas
[→ Cas d’une commande contenant une pièce issue d’un kit](03bc_commande_piece_kit.md)
[→ Cas d’une commande groupée pour plusieurs références client](03bc_commande_groupee.md)
